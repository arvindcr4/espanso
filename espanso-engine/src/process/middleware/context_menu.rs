...
const CONTEXT_ITEM_OPEN_LIBRARY: u32 = 9;
        ...
        match &event.etype {
            EventType::TrayIconClicked => {
                ...
                let mut items = vec![
                    MenuItem::Simple(SimpleMenuItem {
                        id: CONTEXT_ITEM_OPEN_LIBRARY,
                        label: "Open snippet library".to_string(),
                    }),
            ...
            EventType::ContextMenuClicked(context_click_event) => {
                match context_click_event.context_item_id {
                    ...
                    CONTEXT_ITEM_OPEN_LIBRARY => {
                        dispatch(Event::caused_by(event.source_id, EventType::ShowLibrary));
                        Event::caused_by(event.source_id, EventType::NOOP)
                    }
                    10_u32..=u32::MAX => {
